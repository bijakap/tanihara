                            ...
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <form class="w-full max-w-sm" style="display: block;" id="phone_input">
                                    ...
                                    <div class="flex items-center border-b border-teal-500 py-2">
                                        ...
                                        <button class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button" onclick="sendOTP();" id="send_otp">
                                            Send OTP
                                        </button>
                                    </div>
                                </form>
